...
{
	instance_create_layer(obj_player.x, obj_player.y - 75, "lvl_objects", obj_power_meter);
	//Also create the object that handles launch power.
	instance_create_layer(obj_player.x, obj_player.y - 100, "lvl_objects", obj_manage_launch_sprites);
}
